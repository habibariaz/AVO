...
const Contact = () => {
  ...
  return (
    <>
          ...
          <div className="home_mainImgText">
            <motion.div ref={ref}
              ...
              <p className='rendering_text'>
                ...
                &nbsp;&nbsp;Contact <i className="fa fa-chevron-right" aria-hidden="true" style={{ color: "red" }}></i>
              </p>
      ...
      {/* Heading Section */}
      <section>
        <div className="container-fluid top_margin bottom_margin">
          <motion.div ref={ref1}
            initial={{ y: 100, opacity: 0 }}
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-sm-7 mb-3 mb-sm-0">
              <div className="card px-5 border_none">
                <div className="card-body" style={{ height: "550px", backgroundColor: "#F3F3F3" }}>
                  <form style={{ paddingTop: "50px" }}>
                    ...
                    <div className="col-md-6 form-group">
                      <button className="btn btn-danger">Send Message</button><br />
                    </div>
                  </form>
                </div>
              </div>
            ...
            <div className="col-sm-5 contact_margin" >
                ...
                <div className="card-body">
                  <div className="row">
                    ...
                    <motion.div ref={ref2}
                      ...
                      transition={{ duration: 0.5, ease: "easeOut", delay: 0 }} className="col-sm-12">
                      <div className="card border_none">
                        <div className="card-body ">
                          <div className="icon d-flex align-items-right mb-4">
                            <div className='right'>
                              <img src={address} className="img-fluid contact_round_img" alt="Responsive image" />
                            </div>
                            <div className="position ps-3">
                              <h4 className="mb-0">Address:</h4><br />
                    ...
                    <motion.div ref={ref3}
                      ...
                      <div className="card border_none">
                        <div className="card-body">
                          <div className="icon d-flex align-items-right mb-4">
                            <div className='right'>
                              <img src={phone} className="img-fluid contact_round_img" alt="Responsive image" />
                            </div>
                            <div className="position ps-3">
                              <h4 className="mb-0">Phone:</h4><br />
                    ...
                    <motion.div ref={ref4}
                      ...
                      <div className="card border_none">
                        <div className="card-body">
                          <div className="icon d-flex align-items-right mb-4">
                            <div className='right'>
                              <img src={email} className="img-fluid contact_round_img" alt="Responsive image" />
                            </div>
                            <div className="position ps-3">
                              <h4 className="mb-0">Email:</h4><br />
                    ...
                    <motion.div ref={ref5}
                      ...
                      <div className="card border_none">
                        <div className="card-body">
                          <div className="icon d-flex align-items-right mb-4">
                            <div className='right'>
                              <img src={website} className="img-fluid contact_round_img" alt="Responsive image" />
                            </div>
                            <div className="position ps-3">
                              <h4 className="mb-0">Website:</h4><br />
