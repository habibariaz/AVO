...
const About = () => {
  ...
  const isInView8 = useInView(ref8, { once: true, amount: 0.1 });

  const ref9 = useRef(null);
  const isInView9 = useInView(ref9, { once: true, amount: 0.1 });

  const ref10 = useRef(null);
  const isInView10 = useInView(ref10, { once: true, amount: 0.1 });

  const ref11 = useRef(null);
  const isInView11 = useInView(ref11, { once: true, amount: 0.1 });
          ...
          <div className="home_mainImgText">
            <motion.div ref={ref}
              ...
              <p className='rendering_text'>
                ...
                &nbsp;&nbsp;About <i className="fa fa-chevron-right" aria-hidden="true" style={{ color: "red" }}></i>
              </p>
        ...
        <div className="grey_background_card ">
          ...
          <div className="container">
            ...
            <motion.div ref={ref2}
              ...
              transition={{ duration: 0.8, ease: "easeOut", delay: 0 }} className="row" style={{ marginTop: "100px" }}>

              {/* Card 1 */}
              <motion.div ref={ref3}
                initial={{ y: 100, opacity: 0 }}
                animate={isInView3 ? { y: 0, opacity: 1 } : { y: 100, opacity: 0 }}
                transition={{ duration: 0.8, ease: "easeOut", delay: 0 }} className="col-sm-3">
                <div className="card border_none team grey_background_card">
                  <div className="card-body" >
                    {/* Image */}
                    <img src={team1} className="img-fluid" alt="Responsive image" />
                    {/* Social Media Icons */}
                    <div className="overlay align-items-center">
                      <ul>
                        <li className='icons_list'>
                          <a href="/About" className="me-3 text-white"><i className="fa fa-facebook icons-clr"></i></a>
                        </li>
                        <li className='icons_list'>
                          <a href="/About" className="me-3 text-white"><i className="fa fa-twitter icons-clr"></i></a>
                        </li>
                        <li className='icons_list'>
                          <a href="/About" className="text-white" style={{ marginLeft: "10px" }}><i className="fa fa-instagram icons-clr"></i></a>
                        </li>
                      </ul>
                    </div>
                    <div >
              ...
              <motion.div ref={ref4}
                ...
                <div className="card border_none team grey_background_card">
                  <div className="card-body" >
                    {/* Image */}
                    <img src={team2} className="img-fluid" alt="Responsive image" />
                    {/* Social Media Icons */}
                    <div className="overlay align-items-center">
                      <ul>
                        <li className='icons_list'>
              ...
              <motion.div ref={ref5}
                ...
                <div className="card border_none team grey_background_card">
                  <div className="card-body" >
                    {/* Image */}
                    <img src={team3} className="img-fluid" alt="Responsive image" />
                    {/* Social Media Icons */}
                    <div className="overlay align-items-center">
                      <ul>
                        <li className='icons_list'>
              ...
              <motion.div ref={ref6}
                ...
                <div className="card border_none team grey_background_card">
                  <div className="card-body" >
                    {/* Image */}
                    <img src={team5} className="img-fluid" alt="Responsive image" />
                    {/* Social Media Icons */}
                    <div className="overlay align-items-center">
                      <ul>
                        <li className='icons_list'>
            ...
            <motion.div ref={ref7}
              ...
              transition={{ duration: 0.8, ease: "easeOut", delay: 0 }} className="row" >
              {/* Card 1 */}
              <motion.div ref={ref8}
                initial={{ y: 100, opacity: 0 }}
                ...
                <div className="card border_none team grey_background_card">
                  <div className="card-body" >
                    {/* Image */}
                    <img src={team6} className="img-fluid" alt="Responsive image" />
                    {/* Social Media Icons */}
                    <div className="overlay align-items-center">
                      <ul>
                        <li className='icons_list'>
              ...
              <motion.div ref={ref9}
                ...
                <div className="card border_none team grey_background_card">
                  <div className="card-body" >
                    {/* Image */}
                    <img src={team7} className="img-fluid" alt="Responsive image" />
                    {/* Social Media Icons */}
                    <div className="overlay align-items-center">
                      <ul>
                        <li className='icons_list'>
              ...
              <motion.div ref={ref10}
                ...
                <div className="card border_none team grey_background_card">
                  <div className="card-body" >
                    {/* Image */}
                    <img src={team4} className="img-fluid" alt="Responsive image" />
                    {/* Social Media Icons */}
                    <div className="overlay align-items-center">
                      <ul>
                        <li className='icons_list'>
              ...
              <motion.div ref={ref11}
                ...
                <div className="card border_none team grey_background_card">
                  <div className="card-body" >
                    {/* Image */}
                    <img src={team8} className="img-fluid" alt="Responsive image" />
                    {/* Social Media Icons */}
                    <div className="overlay align-items-center">
                      <ul>
                        <li className='icons_list'>
          ...
          <div className='home-ourworkbottom-angled-section'>
            <div className="home-ourworkbottom-left-angled-section"></div>
            <div className="home-ourworkbottom-right-angled-section"></div>
          </div>
        </div>
      </section>
