...
const OurWork = () => {
    ...
    return (
        <>
            ...
            <div className="container-fluid  grey_background_card" >
                <div className="row our_work_card_row">
                    {/* Text Card */}
                    <motion.div
                        ref={ref2}
                        initial={{ y: 100, opacity: 0 }}
                        ...
                        transition={{ duration: 0.8, ease: "easeOut", delay: 0 }}
                        className="col-sm-6 mb-3 mb-sm-0 text-card">
                        <div className="card border_none grey_background_card" style={{ textAlign: "right" }}>
                            <div className="card-body">
                    ...
                    {/* Image Card */}
                    <div
                        className="col-sm-6 image-card" style={{ marginTop: "-50px" }}>
                        <div className="card border_none grey_background_card">
                            <div className="card-body d-flex justify-content-center align-items-center">
            ...
            <div className="container-fluid  grey_background_card" >
                <div className="row our_work_card_row">
                    {/* Image Card */}
                    <div
                        className="col-sm-6 mb-3 mb-sm-0 image-card">
            ...
            <div className="container-fluid grey_background_card" >
                <div className="row our_work_card_row">
                    ...
                    <div className="col-sm-6 image-card" style={{ marginTop: "-50px" }}>
                        <div className="card border_none grey_background_card">
                            <div className="card-body d-flex justify-content-center align-items-center">
            ...
            <div className="container-fluid  grey_background_card" >
                <div className="row our_work_card_row">
                    {/* Image Card */}
                    <div className="col-sm-6 mb-3 mb-sm-0 image-card">
                        <div className="card border_none grey_background_card" style={{ marginTop: "-20px" }}>
                            <div className="card-body d-flex justify-content-center align-items-center">
            ...
            <div className="container-fluid  grey_background_card" >
                <div className="row our_work_card_row">
                    ...
                    {/* Image Card */}
                    <div className="col-sm-6 image-card" style={{ marginTop: "-50px", backgroundColor: "#F3F3F3" }}>
                        <div className="card border_none grey_background_card">
                            <div className="card-body d-flex justify-content-center align-items-center">
