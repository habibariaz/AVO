                        ...
                        <div className='nav_home_text'>
                            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel" >
                                <ol className="carousel-indicators">
                                    <li data-target="#carouselExampleIndicators" data-slide-to="0" className="active" class={currentSlide === 0 ? 'active' : ''}></li>
                                    <li data-target="#carouselExampleIndicators" data-slide-to="1" class={currentSlide === 1 ? 'active' : ''}></li>
                                </ol>

                                <div className="carousel-inner home_carousel angled-section4" id="home_img">
                                    <div className={`carousel-item ${currentSlide === 0 ? 'active' : ''} main-image-carousel`}>
                                        <div className="row">
                                            <div className="col-sm-6 mb-3 mb-sm-0 card-container order-2 order-md-1">
                                                <div className="card cards-background home_mainImgText" >
                                                    <div className="card-body text_left" >
                                                        <motion.div initial={{ y: 50 }}
                                                            ...
                                                            <p className="mb-0"><a href="#" className="btn btn-primary py-md-3 py-2 px-2 px-md-4">Explore Projects</a></p>
                                                        </motion.div>
                                                    </div>
                                                </div>
                                            </div>

                                            <div className="col-12 col-md-6 card-container2 order-1 order-md-2">
                                                <div className="card cards-background home_mainImgText">
                                                    <div className="card-body text_right">
                                                        <motion.div initial={{ y: 50 }}
                                                            animate={{ y: 0 }}
                                                            transition={{ duration: "1", delay: "0" }}>
                                                            <h3><animated.div>
